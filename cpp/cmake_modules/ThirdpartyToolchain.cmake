...
macro(build_opentelemetry)
  ...
  # TODO: require curl/figure out better way to gate this
  if(ARROW_WITH_THRIFT)
    find_package(CURL REQUIRED)
    set(_OPENTELEMETRY_LIBS ${_OPENTELEMETRY_LIBS} exporter_jaeger_trace http_client_curl)
  endif()
  ...
  if(ARROW_WITH_OPENTELEMETRY)
    ...
    if(ARROW_WITH_THRIFT)
      # N.B. Grafana and ElasticSearch have trace viewers now; implement upstream support?
      set(OPENTELEMETRY_CMAKE_ARGS ${OPENTELEMETRY_CMAKE_ARGS} "-DWITH_JAEGER=ON")
      add_compile_definitions("ARROW_WITH_OPENTELEMETRY_JAEGER")
    endif()
  else()
